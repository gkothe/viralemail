...
<body id="home">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="headings">
						...
						<p class="wow animated fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;">Segundo textooooo(sub_titulo)
					</div>
				</div>
			</div>
		</div>
	...
	<br>
	<section id="" class=" overflow-visible">
		<div class="container">
			<div class="title-area text-center">
				<label style="font-weight: 300; color: #444444; font-size: 30px" class="">Compartilhe com seus amigos e dobre a qantidade de conteudos gratuidos</label>
				<hr class="title-under-line-top">
				<hr class="title-under-line-bottom">
			</div>
			<div class="row ">
				<div class="col-md-12" style="text-align: center">
					<label>Aqui esta seu link</label>
				</div>
			</div>
			<div class="row ">
	...
	<section id="video" class=" overflow-visible">
		<div class="container">
			<div class="title-area text-center">
				<h1 class="section-title">Titulo blabla bla!</h1>
				<hr class="title-under-line-top">
				<hr class="title-under-line-bottom">
			</div>
			<div class="row">
				<div class="col-md-12 causes-content">
					<p>Um homem foi encontrado morto em um barranco no Jardim Bela Vista, em Piraquara, na Região Metropolitana de Curitiba. A PolÃ­cia Militar foi acionada na manhÃ£ deste</p>

				</div>
			</div>
		</div>
	</section>
	<section id="" style="background-image: url('${img}/	wp1822726.jpg'); height: 150px" st></section>
	<section id="" class=" overflow-visible" style="background-color: #1FC7FF; padding-top: 20px";;>
		<div class="container">
